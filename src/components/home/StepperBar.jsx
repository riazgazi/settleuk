                        ...
                        return (
                            <React.Fragment key={i}>
                                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4, flex: "none" }}>
                                    <div style={{ width: cur ? 22 : 18, height: cur ? 22 : 18, borderRadius: "50%", background: done ? "#2E6BFF" : cur ? "rgba(124,58,237,0.2)" : "rgba(255,255,255,0.04)", border: `2px solid ${done ? "#2E6BFF" : cur ? "#7C3AED" : "rgba(255,255,255,0.13)"}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: cur ? 8.5 : 7.5, fontWeight: 800, color: done ? "#fff" : cur ? "#A78BFA" : "rgba(255,255,255,0.22)", boxShadow: cur ? "0 0 0 3px rgba(124,58,237,0.2)" : "none", flexShrink: 0 }}>
                                        {done ? "✓" : i === total - 1 ? "🇬🇧" : i + 1}
                                    </div>
                                    <span style={{ fontSize: 7, fontWeight: cur ? 800 : 500, textAlign: "center", whiteSpace: "nowrap", color: cur ? "#A78BFA" : done ? "#3B82F6" : "rgba(255,255,255,0.2)", visibility: showLabel ? "visible" : "hidden" }}>
                                        {i === total - 1 ? "UK" : name}
                                    </span>
                                </div>
                                {i < total - 1 && <div style={{ flex: 1, height: 2, background: done ? "#2E6BFF" : "rgba(255,255,255,0.09)", marginBottom: 14 }} />}
                            </React.Fragment>
                        );
                    })}
                </div>
